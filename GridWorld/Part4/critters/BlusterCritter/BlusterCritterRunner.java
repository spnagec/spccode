...
public final class BlusterCritterRunner
{
    ...
    public static void main(String[] args)
    {
        ...
        world.add(new Location(4, 5), new BlusterCritter(3));
        world.add(new Location(5, 7), new BlusterCritter(2));
        world.add(new Location(4, 3), new BlusterCritter(3));
        world.add(new Location(5, 4), new BlusterCritter(0));
        world.show();
    }
}